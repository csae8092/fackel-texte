                                ...
                                <table class="table table-striped display" id="tocTable" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Sterbetag</th>
                                            <th scope="col">Sterbeort</th> 
                                             <th scope="col">Erwähnungen</th>
                                            <th scope="col">IDNOS</th>
                                            <th scope="col">ID</th> 
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <xsl:variable name="id">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>                                        
                                                     ...
                                                     <td>                                        
                                                        <xsl:value-of select=".//tei:birth/tei:place/text()"/>
                                                    </td>
                                                    <td>                                        
                                                        <xsl:value-of select=".//tei:death/tei:date/text()"/>
                                                    </td>
                                                    <td>                                        
                                                        <xsl:value-of select=".//tei:death/tei:place/text()"/>
                                                    </td> 
                                                     <td>
